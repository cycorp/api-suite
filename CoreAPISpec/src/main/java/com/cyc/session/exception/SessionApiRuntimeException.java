...
/*
 * #%L
 * File: SessionApiRuntimeException.java
...
public class SessionApiRuntimeException extends RuntimeException {
   ...
   */
  public SessionApiRuntimeException(String message) {
    super(message);
  }
   ...
   */
  public SessionApiRuntimeException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @param cause the throwable that caused this exception
   */
  public SessionApiRuntimeException(Throwable cause) {
    super(cause);
  }
}
