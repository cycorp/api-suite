 ...
 * host name, base port, and offset ports. It is easily serializable, and contains 
 * methods for being instantiated from a string.
 * 
 * @author nwinant
 */
public class CycServer extends GenericServerAddress implements Serializable {
   ...
   * @deprecated May be removed in 1.0.0-rc2.
   */
  @Deprecated
  public static final CycServer DEFAULT = new CycServer("localhost", 3600);
  ...
  /**
   * Tests whether a String could be deserialized into a CycServer.
   * @param string to evaluate
   * @return whether it is a serialized CycServer address.
   */
  public static boolean isValidString(String string) {
    if (GenericServerAddress.isValidString(string)) {
      final GenericServerAddress server = GenericServerAddress.fromString(string);
  ...
  /**
   * Generates a CycServer from a serialized representation.
