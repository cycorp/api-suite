...
/**
 * CycSessionException indicates that a Cyc session has been mis-configured
 * or not been configured at all.
 * @author nwinant
 */
public class SessionConfigurationException extends SessionApiException {
  /**
   ...
   */
  public SessionConfigurationException(String s) {
    super(s);
  }
   ...
   */
  public SessionConfigurationException(String s, Throwable cause) {
    super(s, cause);
  }
