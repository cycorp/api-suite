...
public class QueryImpl implements Query, Closeable, InferenceParameterSetter, InferenceParameterGetter {
   ...
   */
  public QueryImpl(final KbIndividual id) throws QueryConstructionException, KbException, UnsupportedCycOperationException {
    this();
 ...
 In general, this method should be avoided. <code>QueryImpl</code> is saved.
   ...
   */
  @Deprecated
  public static QueryImpl loadCycObjectMap(KbIndividual id, Map<CycObject, Object> indexicals) throws UnsupportedCycOperationException, QueryConstructionException, KbException {
 ...
 substitutes in relevant values from the indexicals Map.
   ...
   * @throws com.cyc.session.exception.SessionCommunicationException if there is a problem communicating with
   * Cyc.
   */
  @Override
 ...
 attempt to find for this QueryImpl. In some cases (such as when a set of
   ...
   */
  public InferenceParameterSetter setMaxAnswerCount(Integer max) {
