...
**Latest release:** [![Maven Central](https://img.shields.io/maven-central/v/com.cyc/cyc-core-client-parent.svg)](https://github.com/cycorp/api-suite/releases/tag/core-client-1.0.0-rc5)  
...
The APIs may be used without Maven via the `cyc-core-client-impl-1.0.0-rc5-jar-with-dependencies.jar`.
...
[releases page](https://github.com/cycorp/api-suite/releases/tag/core-client-1.0.0-rc5) as a 
