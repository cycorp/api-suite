 ...
 * @version $Id: DefaultSublWorker.java 162904 2015-12-02 18:35:34Z nwinant $
 */
public class DefaultSublWorker implements Worker {
  ...
  public DefaultSublWorker(CycList subLCommand, CycAccess access, 
      long timeoutMsecs) {
    this(subLCommand, access, false, timeoutMsecs, CycConnectionImpl.NORMAL_PRIORITY);
  }
  ...
  public DefaultSublWorker(CycList subLCommand, CycAccess access, 
      boolean expectIncrementalResults) {
    this(subLCommand, access, expectIncrementalResults, 0, CycConnectionImpl.NORMAL_PRIORITY);
  }
  ...
  public DefaultSublWorker(CycList subLCommand, CycAccess access, 
    ...
    this(subLCommand, access, expectIncrementalResults, timeoutMsecs, CycConnectionImpl.NORMAL_PRIORITY);
  }
