 ...
 * @version $Id: DataTypeConverter.java 163356 2016-01-04 20:55:47Z nwinant $
 */
abstract public class DataTypeConverter<E> {
  
  protected E handleParseException(CycParseException ex, final boolean shouldReportFailure) {
   ...
   */
  protected abstract CycObject toCycTerm(final E obj) throws CycParseException;
   ...
   * Throws a ParseException if the parse fails.
   */
  protected abstract E fromCycTerm(final CycObject cycObject) throws CycParseException;

  protected static Integer parseInteger(final Object obj, final String type) throws CycParseException {
    final Integer result;
    try {
      result = Integer.valueOf(obj.toString());
    } catch (NumberFormatException nfe) {
      throw new CycParseException(obj + " is not a valid " + type + ".");
    }
    return result;
  }

  protected static BigDecimal parseBigDecimal(final Object obj, final String type) throws CycParseException {
  ...
  protected static Float parseFloat(final Object obj, final String type) throws CycParseException {
  ...
  static protected void throwParseException(final Object obj, final String detail) throws CycParseException {
    throw new CycParseException("Can't parse " + obj + ": " + detail);
  }

  static protected void throwParseException(final Object obj) throws CycParseException {
