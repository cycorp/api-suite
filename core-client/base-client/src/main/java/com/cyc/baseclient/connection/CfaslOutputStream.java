 ...
 * 
 * @version $Id: CfaslOutputStream.java 163356 2016-01-04 20:55:47Z nwinant $
 * @author Christopher
...
public class CfaslOutputStream
   ...
   * 
   * @throws IOException if a communications error occurs
   * @throws BaseClientRuntimeException if the argument is Not A Number (NaN)
   */
  ...
  /**
   * Writes an improper (dotted) CycArrayList of Objects to this CfaslOutputStream as a CFASL dotted
 list.
   * 
   ...
   * @throws IOException if a communications error occurs
   */
  public void writeDottedList(CycArrayList dottedList)
                       throws IOException {
  ...
  /**
   * Writes a <tt>GuidImpl</tt> object to this CfaslOutputStream.
   * 
   * @param guid the <tt>GuidImpl</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeGuid(GuidImpl guid)
                 throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  /**
   * Writes a <tt>CycSymbolImpl</tt> object to this CfaslOutputStream.
   * 
   * @param cycSymbol the <tt>CycSymbolImpl</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeSymbol(CycSymbolImpl cycSymbol)
                   throws IOException {
    if (trace == API_TRACE_DETAILED) {
   ...
   * @throws IOException if a communications error occurs
   */
  public void writeKeyword(CycSymbolImpl cycSymbol)
                    throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  /**
   * Writes a <tt>CycVariableImpl</tt> object to this CfaslOutputStream.
   * 
   * @param cycVariable the <tt>CycVariableImpl</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeVariable(CycVariableImpl cycVariable)
                     throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  /**
   * Writes a <tt>CycConstantImpl</tt> object to this CfaslOutputStream.
   * 
   * @param cycConstant the <tt>CycConstantImpl</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeCompleteConstant(CycConstantImpl cycConstant)
                     throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  /**
   * Writes a <tt>Nart</tt> object to this CfaslOutputStream.
   * 
   * @param cycNart the <tt>NartImpl</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeNart(Nart cycNart)
                 throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  /**
   * Writes a <tt>CycAssertionImpl</tt> object to this CfaslOutputStream.
   * 
   * @param cycAssertion the <tt>CycAssertionImpl</tt> to be written
   * 
   * @throws IOException if a communications error occurs
   */
  public void writeAssertion(CycAssertionImpl cycAssertion)
                      throws IOException {
    if (trace == API_TRACE_DETAILED) {
  ...
  public void writeObject(Object o)
    ...
    else if (o instanceof GuidImpl) {
      writeGuid((GuidImpl) o);
    }
    else if (o instanceof CycSymbolImpl) {
      writeSymbol((CycSymbolImpl) o);
    }
    else if (o instanceof CycVariableImpl) {
      writeVariable((CycVariableImpl) o);
    }
    else if (o instanceof CycConstantImpl) {
      writeCompleteConstant((CycConstantImpl) o);
    }
    else if (o instanceof Nart) {
      writeNart((Nart) o);
    }
    else if (o instanceof CycAssertionImpl) {
      writeAssertion((CycAssertionImpl) o);
    }
    else if (o instanceof FormulaImpl) {
      writeList(((FormulaImpl) o).getArgsUnmodifiable());
    }
