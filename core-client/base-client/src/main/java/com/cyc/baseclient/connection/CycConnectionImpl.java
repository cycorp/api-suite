 ...
 *
 * @version $Id: CycConnectionImpl.java 162904 2015-12-02 18:35:34Z nwinant $
...
//  protected int trace = API_TRACE_DETAILED;
 ...
 expressions.
   ...
   */
  public CycConnectionImpl(Socket cfaslSocket) throws CycConnectionException {
    if (Log.current == null) {
      Log.makeLog("cyc-api.log");
    }
    logger = Logger.getLogger(com.cyc.baseclient.connection.CycConnectionImpl.class.getName());
...
//    cfaslInputStream.trace = trace;
 ...
 given communication mode, and the given CycAccess object
   ...
   */
  public CycConnectionImpl(String hostName, int basePort, CycAccess cycAccess) throws CycConnectionException, CycApiException {
    if (Log.current == null) {
      Log.makeLog("cyc-api.log");
    }
    logger = Logger.getLogger(com.cyc.baseclient.connection.CycConnectionImpl.class.getName());
  ...
  public CycConnectionImpl(CycServerAddress server, CycAccess cycAccess) throws CycConnectionException, CycApiException {
  ...
  */
  ...
  public synchronized void close() {
    ...
    try {
      ...
      try {
        ...
        Logger.getLogger(CycConnectionImpl.class.getName()).log(Level.SEVERE, null, ex);
      }
      if (trace > API_TRACE_NONE) {
   ...
   */
  @Override
  public Object[] converseBinary(CycList message, Timer timeout) throws CycConnectionException, CycTimeOutException, CycApiException {
