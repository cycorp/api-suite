 ...
 * @version $Id: CycLeaseManager.java 162904 2015-12-02 18:35:34Z nwinant $
 */
public class CycLeaseManager extends Thread implements LeaseManager {
  ...
  public CycLeaseManager(final CycConnectionImpl cycConnection) {
    ...
    logger = Logger.getLogger(com.cyc.baseclient.connection.CycLeaseManager.class.getName());
