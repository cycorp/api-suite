...
//                b64is.close();
//
                bytes = Base64.readFile( "src/org/opencyc/util/test.gif.b64", false );
   ...
   /**
    ...
    public Object decodeCycObject (final String base64String, final int trace) throws IOException {
        ...
        Base64.InputStream base64InputStream = new Base64.InputStream(byteArrayInputStream, this);
    ...
    public String encodeCycObject (final Object obj, final int trace) throws IOException {
        ...
        Base64.OutputStream base64OutputStream = new Base64.OutputStream(base64ByteStream, this);
     ...
     * @since 1.3
     */
    private byte[] encode3to4( byte[] threeBytes )
     ...
     * @since 1.3
     */
    private byte[] encode3to4( byte[] threeBytes, int numSigBytes )
     ...
     * @since 1.4
     */
    public String encodeObject( java.io.Serializable serializableObject )
    {
     ...
     * @since 1.4
     */
    public String encodeObject( java.io.Serializable serializableObject, boolean breakLines )
    {
        ...
        try
        {
            ...
            b64os = new Base64.OutputStream( baos, this, Base64.ENCODE, breakLines );
     ...
     * @since 1.4
     */
    public String encodeBytes( byte[] source, boolean breakLines )
    {   
    ...
    protected String encodeBytes( byte[] source, int off, int len, boolean breakLines) {
        int    len43   = len * 4 / 3;
     ...
     * @since 1.3
     */
    public String encodeString( String s, boolean breakLines )
    {   
     ...
     * @since 1.4
     */
    public byte[] readFile( String file, boolean encode )
    {
     ...
     * @since 1.4
     */
    public byte[] readFile( java.io.File file, boolean encode )
    {
        ...
        try{
            bis = new Base64.InputStream(
                  ...
                  new java.io.FileInputStream( file ) ), this, encode );
     ...
     * @since 1.4
     */
    public boolean writeFile( byte[] data, String file, boolean encode )
    {
     ...
     * @since 1.4
     */
    public boolean writeFile( byte[] data, java.io.File file, boolean encode )
    {
     ...
     * @since 1.4
     */
    public boolean writeFile( byte[] data, int offset, int length, java.io.File file, boolean encode )
    {
        ...
        try{
            bos = new Base64.OutputStream(
                  ...
                  new java.io.FileOutputStream( file ) ), this, encode );
     ...
     * @since 1.4
     */
    public byte[] decodeFromFile( String encfile )
    {
     ...
     * @since 1.4
     */
    public boolean encodeToFile( byte[] rawdata, String file )
    {
     ...
     * @since 1.4
     */
    public boolean decodeToFile( byte[] encdata, String file )
    {
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
     ...
     * @since 1.3
     */
    private byte[] decode4to3( byte[] fourBytes )
    {
     ...
     * @since 1.3
     */
    public byte[] decode( byte[] source, int off, int len )
    {
        int    len34   = len * 3 / 4;
        ...
        for( i = off; i < off+len; i++ )
        {
            ...
            sbiDecode = getDecodabet()[ sbiCrop ];
    ...
    public static class InputStream extends java.io.FilterInputStream
    {
         ...
         * @since 1.3
         */
        public InputStream( java.io.InputStream in, Base64 base64 )
        {   
            this( in, base64, Base64.DECODE );
        }   // end constructor
         ...
         * @since 1.3
         */
        public InputStream( java.io.InputStream in, Base64 base64, boolean encode )
        {
         ...
         * @since 1.3
         */
        public InputStream( java.io.InputStream in, Base64 base64, boolean encode, boolean breakLines )
        {   
            super( in );
            ...
            if( position < 0 )
            {
                ...
                else
                {
                    ...
                    for( i = 0; i < 4; i++ )
                    {
                        ...
                        int b = 0;
                        do{ b = in.read(); }
                        while( b >= 0 && base64.getDecodabet()[ b & 0x7f ] <= WHITE_SPACE_ENC );
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
         ...
         * @since 1.3
         */
        public OutputStream( java.io.OutputStream out, Base64 base64)
        {   
            this( out, base64, Base64.ENCODE );
        }   // end constructor
         ...
         * @since 1.3
         */
        public OutputStream( java.io.OutputStream out, Base64 base64, boolean encode )
        {
         ...
         * @since 1.3
         */
        public OutputStream( java.io.OutputStream out, Base64 base64, boolean encode, boolean breakLines )
        {   
            super( out );
            this.breakLines   = breakLines;
            this.encode       = encode;
        ...
        public void write(int theByte) throws java.io.IOException 
        {
            ...
            else 
            {
                ...
                if( base64.getDecodabet()[ theByte & 0x7f ] > WHITE_SPACE_ENC )
                {
                    buffer[ position++ ] = (byte)theByte;
                ...
                else if( base64.getDecodabet()[ theByte & 0x7f ] != WHITE_SPACE_ENC )
                {
