...
/********************* Parser ********************/
  final public CycArrayList termList(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycArrayList val = new CycArrayList();
  Object curTerm = null;
    label_1:
    while (true) {
  ...
  final public CycArrayList notForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject sent = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT_CONSTANT:
  ...
  final public CycArrayList andForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycArrayList sentences = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AND_CONSTANT:
  ...
  final public CycArrayList orForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycArrayList sentences = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case OR_CONSTANT:
  ...
  final public CycArrayList xorForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject sent = null;
  ...
  final public CycArrayList impForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject sent = null;
  CycObject sent2 = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      throw new ParseException();
                                                           ...
                                                           val.add(CommonConstants.IMPLIES);
    sent = sentence(false);
                             val.add(sent);
    sent2 = sentence(false);
                              val.add(sent2);
  ...
  final public CycArrayList equivForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject sent = null;
  CycObject sent2 = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public CycArrayList univForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject var = null;
  CycObject sent = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      throw new ParseException();
                                                         ...
                                                         val.add(CommonConstants.FOR_ALL);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  final public CycArrayList existForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                                   ...
                                                                   val.add(CommonConstants.THERE_EXISTS);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  CycArrayList val = new CycArrayList();
    ...
    default:
      ...
      throw new ParseException();
                                                                               ...
                                                                               val.add(CommonConstants.THERE_EXIST_EXACTLY);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  final public CycArrayList existUBoundForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycVariableImpl var = null;
  CycObject sent = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      throw new ParseException();
                                                                             ...
                                                                             val.add(CommonConstants.THERE_EXIST_AT_MOST);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  final public CycArrayList existLBoundForm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycVariableImpl var = null;
  CycObject sent = null;
  CycArrayList val = new CycArrayList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      throw new ParseException();
                                                                               ...
                                                                               val.add(CommonConstants.THERE_EXIST_AT_LEAST);
    var = variable(false);
                            val.add(var);
    sent = sentence(false);
                             val.add(sent);
  ...
  final public CycArrayList genericSentence(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject pred = null;
  CycArrayList args = null;
  ...
  final public CycArrayList sentenceList(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject sent = null;
  CycVariableImpl var = null;
  ...
  final public CycArrayList argumentList(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  Object curTerm = null;
  CycVariableImpl var = null;
  CycArrayList result = new CycArrayList();
    label_3:
  ...
  final public CycArrayList nonAtomicSentenceDenotingDenotationalTerm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycArrayList val;
  ...
  final public CycArrayList nonAtomicDenotationalTerm(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycObject func;
  CycArrayList args;
    jj_consume_token(OPEN_PAREN);
    func = function(false);
...
///// Deal with atoms
  ...
  final public CycConstantImpl sentenceDenotingConstant(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycConstantImpl val = null;
    val = constant(false);
    eof(requireEOF);
    {if (true) return val;}
    throw new Error("Missing return statement in function");
  ...
  final public CycConstantImpl constant(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycConstantImpl val = null;
  Token t = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE_CONSTANT:
  ...
  final public CycConstantImpl makeConstantFromName(String name) throws ParseException {
  CycConstantImpl val = null;
    ...
    if (val == null) {
      try {
        val = new CycConstantImpl(name, null);
      } catch (Exception e) {
  ...
  final public CycConstantImpl makeConstantFromGUID(String guidStr) throws ParseException {
  CycConstantImpl val = null;
  GuidImpl guid = null;
    ...
    if (val == null) {
      try {
        val = new CycConstantImpl(null, guid);
      } catch (Exception e) {
        {if (true) throw new ParseException(e.getMessage());}
      }
    }
  ...
  final public CycConstantImpl coreConstant(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycConstantImpl val = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE_GUID_CONSTANT:
    case FALSE_GUID_CONSTANT:
  ...
  final public CycConstantImpl coreNameConstant(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycConstantImpl val = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE_CONSTANT:
      jj_consume_token(TRUE_CONSTANT);
                        val = CommonConstants.TRUE;
      break;
    case FALSE_CONSTANT:
      jj_consume_token(FALSE_CONSTANT);
                           val = CommonConstants.FALSE;
      break;
    case AND_CONSTANT:
      jj_consume_token(AND_CONSTANT);
                         val = CommonConstants.AND;
      break;
    case OR_CONSTANT:
      jj_consume_token(OR_CONSTANT);
                        val = CommonConstants.OR;
      break;
    case XOR_CONSTANT:
      jj_consume_token(XOR_CONSTANT);
                         val = CommonConstants.XOR;
      break;
    case NOT_CONSTANT:
      jj_consume_token(NOT_CONSTANT);
                         val = CommonConstants.NOT;
      break;
    case EQUIV_CONSTANT:
      jj_consume_token(EQUIV_CONSTANT);
                           val = CommonConstants.EQUIV;
      break;
    case IMPLIES_CONSTANT:
      jj_consume_token(IMPLIES_CONSTANT);
                             val = CommonConstants.IMPLIES;
      break;
    case FORALL_CONSTANT:
      jj_consume_token(FORALL_CONSTANT);
                            val = CommonConstants.FOR_ALL;
      break;
    case THEREEXISTS_CONSTANT:
      jj_consume_token(THEREEXISTS_CONSTANT);
                                 val = CommonConstants.THERE_EXISTS;
      break;
    case THEREEXISTEXACTLY_CONSTANT:
      jj_consume_token(THEREEXISTEXACTLY_CONSTANT);
                                       val = CommonConstants.THERE_EXIST_EXACTLY;
      break;
    case THEREEXISTATMOST_CONSTANT:
      jj_consume_token(THEREEXISTATMOST_CONSTANT);
                                      val = CommonConstants.THERE_EXIST_AT_MOST;
      break;
    case THEREEXISTATLEAST_CONSTANT:
      jj_consume_token(THEREEXISTATLEAST_CONSTANT);
                                       val = CommonConstants.THERE_EXIST_AT_LEAST;
      break;
    case EXPANDSUBLFN_CONSTANT:
      jj_consume_token(EXPANDSUBLFN_CONSTANT);
                                  {if (true) throw new UnsupportedVocabularyException(CommonConstants.EXPAND_SUBL_FN);}
      break;
    case SUBLQUOTEFN_CONSTANT:
      jj_consume_token(SUBLQUOTEFN_CONSTANT);
                                 {if (true) throw new UnsupportedVocabularyException(CommonConstants.SUBL_QUOTE_FN);}
      break;
    default:
      jj_la1[27] = jj_gen;
      jj_consume_token(-1);
  ...
  final public CycConstantImpl coreGUIDConstant(boolean requireEOF) throws ParseException, java.io.IOException, UnsupportedVocabularyException {
  CycConstantImpl val = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE_GUID_CONSTANT:
  ...
  final public CycVariableImpl sentenceDenotingVariable(boolean requireEOF) throws ParseException {
  CycVariableImpl val = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SIMPLE_VARIABLE:
  ...
  final public CycVariableImpl variable(boolean requireEOF) throws ParseException {
  CycVariableImpl val = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SIMPLE_VARIABLE:
  ...
  final public CycVariableImpl sentenceDenotingMetaVariable(boolean requireEOF) throws ParseException {
  CycVariableImpl val = null;
    val = metaVariable(false);
    eof(requireEOF);
    {if (true) return val;}
  ...
  final public CycVariableImpl sentenceDenotingSimpleVariable(boolean requireEOF) throws ParseException {
  CycVariableImpl val = null;
    val = simpleVariable(false);
    eof(requireEOF);
    {if (true) return val;}
  ...
  final public CycVariableImpl metaVariable(boolean requireEOF) throws ParseException {
  CycVariableImpl val = null;
  Token t = null;
    t = jj_consume_token(META_VARIABLE);
                            val = new CycVariableImpl(t.image);
    eof(requireEOF);
    {if (true) return val;}
    throw new Error("Missing return statement in function");
  }

  final public CycVariableImpl simpleVariable(boolean requireEOF) throws ParseException {
  CycVariableImpl val = null;
  Token t = null;
  ...
  public CyclParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new BaseClientRuntimeException(e); }
  ...
  public void ReInit(java.io.InputStream stream, String encoding) {
    try { jj_input_stream.ReInit(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new BaseClientRuntimeException(e); }
