...
public class CycObjectLibraryTest {
  ...
  @Test
  public void testKBPopulator() throws CycConnectionException, SessionException {
  ...
  @Test
  public void testTestGuids() throws CycConnectionException, CycApiException, SessionException {
    ...
    if (isEnterpriseCyc()) {
      ...
      missingStrings.remove(BUSH_DOG_GUID_STRING);
    }
