...
public class InstanceRestrictedVariable extends RestrictedVariable {
  ...
  public InstanceRestrictedVariable(Context ctx, KbCollection c) throws KbException {
    super(ctx, ((KbCollectionImpl) c).getVariable(), new Object[]{KbPredicateImpl.get("isa"), ((KbCollectionImpl) c).getVariable(), c});
    this.setCollection(c);
  }
  
  public InstanceRestrictedVariable(Context ctx, KbCollection c, Variable v) throws KbException {
