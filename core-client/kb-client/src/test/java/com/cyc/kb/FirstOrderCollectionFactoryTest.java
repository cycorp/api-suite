...
/*
 * #%L
 * File: FirstOrderCollectionFactoryTest.java
 * Project: KB Client
 * %%
 ...
 * @author nwinant
 */
public class FirstOrderCollectionFactoryTest {
  
  // Tests
  
  @Test
  public void testGetInstance() throws Exception {
    FirstOrderCollectionFactory instance = FirstOrderCollectionFactory.getInstance();
