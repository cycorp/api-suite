...
/*
 * #%L
 * File: SecondOrderCollectionFactoryTest.java
 * Project: KB Client
 * %%
 ...
 * @author nwinant
 */
public class SecondOrderCollectionFactoryTest {
  
  // Tests
  
  @Test
  public void testGetInstance() throws Exception {
    SecondOrderCollectionFactory instance = SecondOrderCollectionFactory.getInstance();
