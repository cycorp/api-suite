...
public class InferenceParameterComparatron {
  ...
  public InferenceParameterComparatron(final CycServer rcycAddress, final CycServer ocycAddress, long timeoutMsecs) throws SessionApiException {
    this.rcyc = CycAccessManager.get().getAccess(rcycAddress);
    this.ocyc = CycAccessManager.get().getAccess(ocycAddress);
    this.timeoutMsecs = timeoutMsecs;
  }
  
  public InferenceParameterComparatron(final String rcycAddress, final String ocycAddress, long timeoutMsecs) throws SessionApiException {
  ...
  public void compare() throws SessionApiException {
  ...
  public void printResults() throws SessionApiException {
