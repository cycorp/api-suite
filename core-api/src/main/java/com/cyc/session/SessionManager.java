 ...
 * configuration, to creation, to caching, to cleanup, and providing appropriate CycSessions to API
 * and application code that requires them.
 *
 * @author nwinant
 * @param <T>
 */
public interface SessionManager<T extends CycSession> extends Closeable {
   ...
   * CycConfigurationManager to connect to a Cyc server.
   * @throws SessionCommunicationException if the application encounters problems communicating with
   * a Cyc server.
   * @throws SessionInitializationException if the application encounters problems initializing the
   * CycSession.
   */
  //T getCurrentSession(SessionCriteria criteria) 
  //        throws SessionConfigurationException, SessionCommunicationException, 
  //        SessionInitializationException;
   ...
   * @throws SessionConfigurationException if the application is not sufficiently configured for the
   * CycSession to identify a Cyc server.
   * @throws SessionCommunicationException if the application encounters problems communicating with
   * a Cyc server.
   * @throws SessionInitializationException if the application encounters problems initializing the
   * CycSession.
   ...
   * CycSession.
   */
  //T createSession(SessionCriteria criteria)
  //        throws SessionConfigurationException, SessionCommunicationException, 
  //        SessionInitializationException;
