...
public interface KbFunction extends Relation {
  ...
  /**
   * Get the <code>KbFunction</code> with the name <code>nameOrId</code>. This static method wraps a
   * call to {@link KbFunctionService#get(java.lang.String) }; see that method's documentation for
   * more details.
   *
  ...
  public static KbFunction findOrCreate(String nameOrId) throws CreateException, KbTypeException {
    return Cyc.getKbFunctionService().findOrCreate(nameOrId);
  }
  
  public static KbFunction findOrCreate(String nameOrId, String constraintColStr)
          throws CreateException, KbTypeException {
    return Cyc.getKbFunctionService().findOrCreate(nameOrId, constraintColStr);
  }
  
  public static KbFunction findOrCreate(String nameOrId, String constraintColStr, String ctxStr)
          throws CreateException, KbTypeException {
    return Cyc.getKbFunctionService().findOrCreate(nameOrId, constraintColStr, ctxStr);
  }
  
  public static KbFunction findOrCreate(String nameOrId, KbCollection constraintCol)
          throws CreateException, KbTypeException {
    return Cyc.getKbFunctionService().findOrCreate(nameOrId, constraintCol);
  }

  public static KbFunction findOrCreate(String nameOrId, KbCollection constraintCol, Context ctx)
          throws CreateException, KbTypeException {
    return Cyc.getKbFunctionService().findOrCreate(nameOrId, constraintCol, ctx);
  }
  
  public static boolean existsAsType(String nameOrId) {
    return Cyc.getKbFunctionService().existsAsType(nameOrId);
  }
  
  public static KbStatus getStatus(String nameOrId) {
    return Cyc.getKbFunctionService().getStatus(nameOrId);
  }
