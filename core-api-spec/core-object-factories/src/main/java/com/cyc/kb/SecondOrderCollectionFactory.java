...
/*
 * #%L
 * File: SecondOrderCollectionFactory.java
 ...
 * @author nwinant
 */
public class SecondOrderCollectionFactory {

  // Static
  
  private static final SecondOrderCollectionFactory ME = new SecondOrderCollectionFactory();

  protected static SecondOrderCollectionFactory getInstance() {
    return ME;
  }
  ...
  private final SecondOrderCollectionService service;

  
  // Construction
  
  private SecondOrderCollectionFactory() {
    service = CoreServicesLoader.getKbFactoryServices().getSecondOrderCollectionService();
  }

  protected SecondOrderCollectionService getService() {
    return service;
  }
   ...
   */
  public static SecondOrderCollection get(String nameOrId) throws KbTypeException, CreateException {
   ...
   * @throws CreateException
   */
  public static SecondOrderCollection findOrCreate(String nameOrId)
