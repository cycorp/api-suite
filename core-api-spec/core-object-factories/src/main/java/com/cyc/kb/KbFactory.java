...
public class KbFactory {
   ...
   * </ol>
   * 
   * <p>When returning a KbTerm or Assertion, this method will always attempt to return an instance 
   * of the most specific subclass possible. For example, "#$WeatherQuantity" will be returned as an
   * instance of FirstOrderCollection.
   * 
   * <p>This method attempts to follow a least-common-denominator principle of least surprise, but 
   * do be aware that some strings may have multiple possible representations as KbObjects. For 
  ...
  public static KbObject getKbObject(String cycLOrId) throws KbTypeException, CreateException {
    return getInstance().getConvenienceService().getKbObject(cycLOrId);
  }
