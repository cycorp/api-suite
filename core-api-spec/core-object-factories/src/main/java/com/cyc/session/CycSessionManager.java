...
public class CycSessionManager {
  ...
  static {
    try {
      ...
      throw new CycSessionManagerInitializationError(CycSessionManager.class.getName()
  ...
  */
  ...
  private static synchronized void loadSessionManager() 
    ...
    if (sessionMgrs.isEmpty()) {
      throw new SessionServiceException(SessionManager.class, "Could not find any " 
