...
public interface InferenceParameterSetter {
   ...
   * @return this object
   */
  InferenceParameterSetter setBrowsable(boolean browsable);
   ...
   * @return this object
   */
  InferenceParameterSetter setContinuable(boolean continuable);
   ...
   * @return this object.
   */
  InferenceParameterSetter setMaxAnswerCount(Integer maxAnswers);
   ...
   * @return this object.
   */
  InferenceParameterSetter setMaxTime(Integer maxSeconds);
   ...
   * @return this object.
   */
  InferenceParameterSetter setMaxTransformationDepth(Integer depth);
