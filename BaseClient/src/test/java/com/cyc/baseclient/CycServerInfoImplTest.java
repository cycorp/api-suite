...
public class CycServerInfoImplTest {
  ...
  @Test
  public void testIsOpenCyc() throws SessionApiException, CycConnectionException {
    assertEquals(access.isOpenCyc(), serverInfo.isOpenCyc());
  }
  
  @Test
  public void testGetSystemTypeString() throws SessionApiException, CycConnectionException {
  ...
  @Test
  public void getSystemType() throws SessionApiException, CycConnectionException {
