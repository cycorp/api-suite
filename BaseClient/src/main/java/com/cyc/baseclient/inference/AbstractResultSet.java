...
/**
 * <P>
 * AbstractResultSet provides a class for easy access and manipulation of
...
public abstract class AbstractResultSet implements ResultSet, InferenceResultSet {
  ...
  //// Public Area
  /**
   * Releases this <code>AbstractResultSet</code> object's server side
   * resources. Failure to close a result set may leave significant resources
   * hanging around the server until the client object is closed.
   * <P>
  ...
  /**
   * Retrieves whether this <code>AbstractResultSet</code> object has been
   * closed. A <code>AbstractResultSet</code> is closed if the method close has
   * been called on it.
   *
   * @return true if this <code>AbstractResultSet</code> object is closed; false
   * if it is still open
   */
  @Override
   ...
   * <code>AbstractResultSet</code> object.
   * <p/>
   * <strong>Note:</strong> Calling the method <code>isLast</code> may be
   * expensive because if the inference is asynchronous, it first needs to wait
   * until the inference is complete.
   *
  ...
  /**
   * Moves the cursor to the front of this <code>AbstractResultSet</code>
   * object, just before the first row. This method has no effect if the result
  ...
  /**
   * Moves the cursor to the end of this <code>AbstractResultSet</code> object,
   ...
   * positive number indicates the row number counting from the beginning of the
   * result set; a negative number indicates the row number counting from the
   * end of the result set
   * @return <code>true</code> if the cursor is moved to a position in this
   * <code>AbstractResultSet</code> object; <code>false</code> if the cursor is
   ...
   * <code>relative(0)</code> is valid, but does not change the cursor position.
   *
   * <p>
   ...
   *
   * <P/>
   * <strong>Note:</strong> Calling the method <code>relative</code> may be
   * expensive because if the inference is asynchronous, it first needs to wait
   * until the inference is complete.
   *
   * @param row
  ...
  /**
   * Moves the cursor to the first row in this <code>AbstractResultSet</code>
   * object.
   *
  ...
  /**
   * Moves the cursor to the last row in this <code>AbstractResultSet</code>
   * object.
   *
   * <P/>
   * <strong>Note:</strong> Calling the method <code>last</code> may be
   * expensive because if the inference is asynchronous, it first needs to wait
   * until the inference is complete.
   *
   * @return <code>true</code> if the cursor is on a valid row;
  ...
  /**
   * Moves the cursor to the previous row in this <code>AbstractResultSet</code>
   * object.
   * <p>
   * When a call to the <code>previous</code> method returns <code>false</code>,
   * the cursor is positioned before the first row. Any invocation of a
   * <code>AbstractResultSet</code> method which requires a current row will
   * result in a <code>SQLException</code> being thrown.
   * <p>
   * If an input stream is open for the current row, a call to the method
   * <code>previous</code> will implicitly close it. A
   * <code>AbstractResultSet</code> object's warning change is cleared when a
   * new row is read.
   * <p>
   *
   ...
   * <code>AbstractResultSet</code> cursor is initially positioned before the
   ...
   * column identified by <code>col</code>. Returns <code>null</code> if no
   * value is set for the current row and given column.
   *
   * <p/>
   * <strong>Note:</strong> Use the method <code>int colIindex = findColumn(col)<code> once
   ...
   * @return the value, as an <code>Object</code>, at the current row and at the
   * column identified by the <code>col</code>. Returns <code>null</code>, if no
   * value is set for the current row and given column.
  ...
  /**
   * Returns, as an <code>Object</code>, the value at the current row and at the
   * column identified by <code>colIndex</code>. Returns <code>null</code> if no
   * value is set for the current row and given column.
   *
   * @param colIndex the column index of interest (one-based)
   * @return the value, as an <code>Object</code>, at the current row and at the
   * column identified by <code>colIndex</code>. Returns <code>null</code>, if
  ...
  public Object getObject(int colIndex)
    ...
    if ((colIndex <= 0) || (colIndex > getMaxColumns())) {
      ...
      throw new ArrayIndexOutOfBoundsException(getRow() + " is not a valid row");
    }
    return curRow.get(colIndex - 1);
  }

  /**
   * Returns, as a <code>DenotationalTerm</code>, the value at the current row
   * and at the column identified by <code>col</code>. Returns <code>null</code>
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>DenotationalTerm</code>, at the current row
   * and at the column identified by the <code>col</code>. Returns
  ...
  /**
   * Returns, as a <code>DenotationalTerm</code>, the value at the current row
   * and at the column identified by <code>colIndex</code>. Returns
   * <code>null</code> if no value is set for the current row and given column.
   *
   * @param colIndex the column index of interest (one-based)
   * @return the value, as a <code>DenotationalTerm</code>, at the current row
   ...
   * column identified by the <code>col</code>y. Returns <code>null</code>, if
   * no value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
   * valid row
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>boolean</code>, at the current row and at the
   * column identified by the <code>col</code>. Returns <code>null</code>, if no
   * value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
  ...
  /**
   * Returns, as a <code>boolean</code>, the value at the current row and at the
   * column identified by <code>colIndex</code>. Returns </code>false<code>
   * if there is no value for the variable or if the value is #$False.  Otherwise returns true.
   *
   * @param colIndex the column index of interest (one-based)
   * @return the value, as a <code>boolean</code>, at the current row and at the
   * column identified by <code>colIndex</code>. Returns <code>null</code>, if
  ...
  public boolean getBoolean(int colIndex)
    ...
    if (val == null || val.equals(CommonConstants.FALSE)) {
      return false;
    }
    return true;
  }
  ...
  /**
   * Returns, as a <code>CycConstantImpl</code>, the value at the current row
   * and at the column identified by <code>col</code>. Returns <code>null</code>
   * if no value is set for the current row and given column.
   *
   * <p/>
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>CycConstantImpl</code>, at the current row
   * and at the column identified by the <code>col</code>. Returns
   * <code>null</code>, if no value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
   ...
   */
  @Override
  public CycConstantImpl getConstant(String col)
          throws IllegalArgumentException, ArrayIndexOutOfBoundsException, ClassCastException {
  ...
  /**
   * Returns, as a <code>CycObject</code>, the value at the current row and at
   * the column identified by <code>col</code>. Returns <code>null</code> if no
   * value is set for the current row and given column.
   *
   * <p/>
   * <strong>Note:</strong> Use the method <code>int colIindex = findColumn(col)<code> once
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>CycObject</code>, at the current row and at
   * the column identified by the <code>col</code>. Returns <code>null</code>,
   * if no value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
   * valid row
  ...
  /**
   * Returns, as a <code>CycObject</code>, the value at the current row and at
   * the column identified by <code>colIndex</code>. Returns <code>null</code>
   * if no value is set for the current row and given column. Note: literal
   * strings and numbers are not CycObjects and can possibly be returned by some
   * inferences. Only call this method if you are sure that literals are not a
   * valid return result for the given <code>colIndex</code> or a
   * ClassCastException will be thrown when a literal is encountered.
   *
   * @param colIndex the column index of interest (one-based)
   * @return the value, as a <code>CycObject</code>, at the current row and at
   * the column identified by <code>colIndex</code>. Returns <code>null</code>,
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>Fort</code>, at the current row and at the
   * column identified by the <code>col</code>. Returns <code>null</code>, if no
   * value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
  ...
  public Fort getFort(int colIndex)
          throws IllegalArgumentException, ArrayIndexOutOfBoundsException, ClassCastException {
    ensureOpen("getFort");
    return (Fort) getObject(colIndex);
  }

  /**
   * Returns, as a <code>CycArrayList</code>, the value at the current row and
   * at the column identified by <code>col</code>. Returns <code>null</code> if
   * no value is set for the current row and given column.
   *
   * <p/>
   * <strong>Note:</strong> Use the method <code>int colIindex = findColumn(col)<code> once
   ...
   * at the column identified by the <code>col</code>. Returns
   * <code>null</code>, if no value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
   * valid row
  ...
  /**
   * Returns, as a <code>Nart</code>, the value at the current row and at the
   * column identified by <code>col</code>. Returns <code>null</code> if no
   * value is set for the current row and given column.
   *
   * <p/>
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>NartImpl</code>, at the current row and at
   * the column identified by the <code>col</code>. Returns <code>null</code>,
   * if no value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
  ...
  /**
   * Returns, as a <code>NartImpl</code>, the value at the current row and at
   * the column identified by <code>colIndex</code>. Returns <code>null</code>
   * if no value is set for the current row and given column.
   *
   * @param colIndex the column index of interest (one-based)
  ...
  public Nart getNart(int colIndex)
          throws IllegalArgumentException, ArrayIndexOutOfBoundsException, ClassCastException {
    ensureOpen("getNart");
    return (Nart) getObject(colIndex);
  }
   ...
   *
   * @param col the name of the variable that represents the column of interest
   * @return the value, as a <code>Naut</code>, at the current row and at the
   * column identified by the <code>col</code>. Returns <code>null</code>, if no
   * value is set for the current row and given column.
   * @throws IllegalArgumentException if <code>col</code> is not valid
   * @throws ArrayIndexOutOfBoundsException if the current cursor is not on a
  ...
  public Naut getNaut(int colIndex)
    ...
    return (NautImpl) getObject(colIndex);
  }

  /**
   * Returns, as a <code>java.sql.Date</code> object, the value at the current
   * row and at the column identified by <code>col</code> which should be a
  ...
  public Date getDate(int colIndex)
    ...
    return new Date(DateConverter.parseCycDate(((Naut) NautImpl.convertIfPromising(obj))).getTime());
  }
  ...
  /**
   * Returns a list (view) of column names that are available.
   *
   * @return a list (view) of column names that are available.
   */
  @Override
  ...
  /**
   * Returns whether the query is a simple truth query.
   *
   * @return true iff either Cyc found no answers for the query, or else the
   * query has no open variables and was proven true.
   */
  @Override
  ...
  public boolean getTruthValue() {
    if (!hasTruthValue()) {
      throw new BaseClientRuntimeException("Attempt to get the truth value for a result set with non-truth value data.");
    }
    return truthValue;
  }
  ...
  /**
   * Returns the column index for the given <code>col</code>. This version
   * differs from the non-strict version in that it throws detailed error
   * messages.
   *
   ...
   * @throws BaseClientRuntimeException if this <code>AbstractResultSet</code> object is
   * not open
   */
  protected void ensureOpen(String methodName) {
    if (isClosed) {
      throw new BaseClientRuntimeException(methodName
  ...
  /**
   * Get the actual list of column names. Changes to returned list therefore
   * destructively modify the list of column names of this result set.
   *
  ...
  /**
   * The possible column names for this query. It is currently based on results
   * retreived so far.
   */
  private final List<String> columnNames = new ArrayList<String>(8);
  /**
   * The current cursor location (zero-based). If the cursor is at 0, the
   * current row is row 1, etc.
   */
  private int cursor = -1;
  /**
   * The current row. Null if cursor is before the beginning or after the end of
   * the result set.
   */
