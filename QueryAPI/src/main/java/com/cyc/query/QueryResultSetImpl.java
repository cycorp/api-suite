...
//  }
   ...
   * @throws ArrayIndexOutOfBoundsException
   */
  public <T> T getKBObject(Variable variable, Class<T> type) throws IllegalArgumentException, KBApiException {
   ...
   */
  @Override
  public <T> T getKBObject(String columnLabel, Class<T> type) throws IllegalArgumentException, KBApiException {
    try {
      Object obj = rs.getObject(columnLabel);
      return KBObjectImpl.<T>checkAndCastObject(obj);
    } catch (SQLException ex) {
